...
export default async function Home() {
  ...
  // Récupérer la VMA stockée dans les métadonnées
  ...
  // Note: Si l'utilisateur n'est pas approuvé, il sera redirigé vers /waiting par le middleware
  // Donc ici, on peut charger les données en toute sécurité
